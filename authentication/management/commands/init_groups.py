    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            superadmin_group.permissions.add(
                ...
                Permission.objects.get(codename='add_residents'),
                Permission.objects.get(codename='change_residents'),
                Permission.objects.get(codename='view_residents'),
        ...
        admin_group.permissions.add(
            ...
            Permission.objects.get(codename='add_residents'),
            Permission.objects.get(codename='change_residents'),
            Permission.objects.get(codename='delete_residents'),
            Permission.objects.get(codename='view_residents'),
            Permission.objects.get(codename='view_residents'),
            Permission.objects.get(codename='view_carehomes'),
            Permission.objects.get(codename='add_carehomemanagers'),
