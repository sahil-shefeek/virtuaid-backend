    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            superadmin_group.permissions.add(
                ...
                Permission.objects.get(codename='add_associates'),
                Permission.objects.get(codename='change_associates'),
                Permission.objects.get(codename='view_associates'),
        ...
        admin_group.permissions.add(
            ...
            Permission.objects.get(codename='add_associates'),
            Permission.objects.get(codename='change_associates'),
            Permission.objects.get(codename='delete_associates'),
            Permission.objects.get(codename='view_associates'),
            Permission.objects.get(codename='view_associates'),
            Permission.objects.get(codename='view_carehomes'),
            Permission.objects.get(codename='add_carehomemanagers'),
